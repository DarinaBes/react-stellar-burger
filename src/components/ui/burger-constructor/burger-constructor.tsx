...
export const BurgerConstructorUI: FC<BurgerConstructorUIProps> = ({
  ...
  return (
    <section className={styles.burger_constructor} data-cy='constructor'>
      ...
      <ul className={styles.elements} data-cy='constructorIngredients'>
